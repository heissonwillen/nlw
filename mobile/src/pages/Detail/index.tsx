...
import { View, Text, Image, StyleSheet, TouchableOpacity, SafeAreaView, Fragment, Linking } from 'react-native';
            ...
            <View>
                <SafeAreaView style={{flex: 1}}>
                    <View  style={styles.container}>
                        <Text style={styles.pointName}>Carregando...</Text>
                        <Text style={styles.pointItems}>Informações indisponíveis no momento. :/</Text>
                    </View>
                </SafeAreaView>
            </View>
        );
        ...
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.footer}>
                <RectButton style={styles.button} onPress={handleWhatsapp}>
                    ...
                    <Text style={styles.buttonText}>WhatsAspp</Text>
                </RectButton>
